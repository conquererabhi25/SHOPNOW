      ...
      <div className="flex flex-col w-full pt-1 md:pt-0">
        ...
        >
          ...
          >
            <button
              type="button"
              className="flex px-3  h-8 py-2 gap-1 bg-blue-600 text-white rounded-md text-xs md:text-sm cursor-pointer"
            >
              <FaFilterCircleDollar size={20} />
              <p>Filters</p>
            </button>
...
//   useEffect(() => {
//     if (searchQuery === "") {
//       const timeout = setTimeout(() => navigate(lastVisitedPage), 300);
//       return () => clearTimeout(timeout);
//     }
//   }, [searchQuery, lastVisitedPage, navigate]);
...
//           >
//             <div className="flex items-center rounded-lg bg-gray-200 p-1 mx-2 w-[40vw] h-10">
//               <button type="submit">
//                 <IoMdSearch
//                   size={20}
//                   className="mx-2 text-gray-500 cursor-pointer"
